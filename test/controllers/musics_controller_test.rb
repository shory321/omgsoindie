...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { Album: @music.Album, Artist: @music.Artist, Price: @music.Price, Released: @music.Released }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { Album: @music.Album, Artist: @music.Artist, Price: @music.Price, Released: @music.Released }
    assert_redirected_to music_path(assigns(:music))
  end
